  ...
  return (
    <nav className="bg-white/10 backdrop-blur-md fixed w-full z-20 top-0 start-0 border-b border-white/20 shadow-lg">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto px-4 py-3">
        {/* Logo / Name */}
        <span className="self-center text-xl sm:text-2xl font-bold text-white">
          Chandru
        </span>
        ...
        <div className="flex items-center gap-3 md:order-2">
          {/* Profile Pic */}
          <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-full overflow-hidden border-2 border-blue-400 shadow-lg">
            <img
              src="/PROFILE PIC.jpg"
              alt="Profile"
        ...
        >
          <ul className="flex flex-col md:flex-row md:space-x-8 mt-4 md:mt-0 p-4 md:p-0 font-medium border md:border-0 border-white/20 rounded-lg bg-white/10 md:bg-transparent text-lg">
