...
const Skills = () => {
  ...
  return (
    <div className="bg-gray-900 w-full px-4 sm:px-8 md:px-16 lg:px-20 py-12 sm:py-16 flex flex-col items-center">
      <h1 className="text-2xl sm:text-3xl md:text-4xl font-extrabold text-white text-center mb-10">
        Skills
      </h1>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-6 w-full max-w-5xl">
        {skillList.map((skill, index) => (
          ...
          >
            ...
            />
            <p className="mt-3 text-white text-sm sm:text-base md:text-lg font-medium text-center">
              {skill.name}
            </p>
          </div>
        ))}
